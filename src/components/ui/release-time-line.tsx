...
export default function TimeLine_01({
  ...
  return (
    <>
      <div>
        <h1 className="from-primary to-primary/60 mb-4 bg-gradient-to-r bg-clip-text text-3xl font-bold tracking-tight text-transparent md:text-5xl">
          {title}
        </h1>
        <p className="text-muted-foreground mb-6 text-base">{description}</p>
      </div>

      <div className="mx-auto mt-16 space-y-16 md:mt-24 md:space-y-24">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2
                      className={
                        "text-md leading-tight font-medium tracking-tight transition-colors duration-200 md:text-lg " +
                      ...
                      <div className="space-y-4 pt-2">
                          ...
                          <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-black">
                            <ul className="space-y-2">
                              {entry.items.map((item, itemIndex) => (
                                ...
                                >
                                  <div className="bg-primary/60 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full" />
                        ...
                        {entry.button && (
                          <div className="flex justify-end">
                            ...
                            >
                              <Link
                                href={entry.button.url as never}
                                target="_blank"
                                rel="noreferrer"
                              >
                                {entry.button.text}
